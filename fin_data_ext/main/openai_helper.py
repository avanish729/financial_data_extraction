...
# def poem_on_samosa():
#     prompt='write a poem on samosa .only 4 lines please'

# response=openai.ChatCompletion.create(
#     model="gpt-3.5-turbo",
#     messages=[
#     {"role": "user", "content": "write a poem on samosa .only 4 lines please."},
...
def extract_financial_data(text):
    ...
    try:
        ...
        return pd.DataFrame(data.items(),columns=["measure","values"])
